...
export class GlobalQueryFilter<T> {
    ...
    constructor(query: QueryParamsDto, attributes: string[]) {
    ...
    setFields() {
        if (this.query.fields) {
            this.attributes = this.query.fields.filter(field => this.attributes.includes(field));
        }
        return this;
    }
    ...
    setSearch() {
        if (this.query.search) {
            this.where[Op.or] = this.attributes
